...
<div class="container-fluid page_title_container">
    <div class="row">
        <div class="col spothit_header">
            <h1 class="m-0"><?php _e('Manual SMS campaign', 'spothit') ?></h1>
        </div>
    </div>
</div>

<div class="container-fluid page_content_container page_sms_content_container">
    <div class="row">
        <div class="col">
            <div class="spothit_main">
                <div id="spothit_breadcramp">
                    ...
                    <div data-page="4">
                        <span>4</span>
                        <span><?php _e('Message', 'spothit') ?></span>
                    </div>
                ...
                <div class="spothit_content">
                    <div id="spothit_form" data-action="SH_ajax_api_request" data-url="envoyer/sms">
                        ...
                        <div id="spothit_page_content">
                            ...
                            <div data-page="1">
                                <?php require_once(SH_DIR_PATH . 'views/sms_campaign/step1.php') ?>
                            </div>
                            <div data-page="2">
                                <?php require_once(SH_DIR_PATH . 'views/sms_campaign/step2.php') ?>
                            </div>
                            <div data-page="3">
                                <?php require_once(SH_DIR_PATH . 'views/sms_campaign/step3.php') ?>
                            </div>
                            <div data-page="4">
                                <?php require_once(SH_DIR_PATH . 'views/sms_campaign/step4.php') ?>
                            </div>
                            <div data-page="5">
                                <?php require_once(SH_DIR_PATH . 'views/sms_campaign/step5.php') ?>
                            </div>
                            <div data-page="6">
                                <?php require_once(SH_DIR_PATH . 'views/sms_campaign/step6.php') ?>
                            </div>
                ...
                <div id="spothit_preview">
                    <div class="smartphone">
                        ...
                        <div class="smartphone__screen">
                            <div class="smartphone_sender">
                                36200
                            </div>
                            <div id="msg_preview" class="message">
                                <p></p>
                            </div>
                            <div class="smartphone_initials"><i class="fa-solid fa-user"></i></div>
                        </div>
                        <div class="smartphone__bottom">
