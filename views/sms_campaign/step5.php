<div class="page_title">
    <h2><i class="fa-light fa-alarm-clock fa-lg me-1"></i>
        <?php _e('Date', 'spothit') ?></h2>
</div>
<div class="content">
            ...
            <div class="col-md-6">
                ...
                <label class="multi_box_label h-100" for="date_now">
                    <div class="input_container">
                        ...
                        <p><?php _e('SMS will be sent when the campaign is validated', 'spothit') ?>
                        </p>
                    </div>
                </label>
            </div>
            <div class="col-md-6">
                ...
                <label class="multi_box_label h-100" for="date_scheduled">
                    <div class="input_container">
                        ...
                        <p class="input_title"><?php _e('Scheduled', 'spothit') ?></p>
                        <p><?php _e('Select a datetime for sending', 'spothit') ?>
                        </p>
